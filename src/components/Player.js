...
const Player = ({ songs, setSongs, currentSong, setCurrentSong, audioRef, isPlaying, setIsPlaying, songInfo, setSongInfo }) => {
    ...
    const trackAnim = {
        transform: `translateX(${songInfo.amnimationPercentage}%)`
    }
